...
class XWalkExtensionServer : public IPC::Listener {
 public:
  ...
  void Initialize(IPC::Sender* sender,
      XWalkExternalExtension::PermissionsDelegate* delegate = NULL);
  ...
  XWalkExternalExtension::PermissionsDelegate* permissions_delegate() {
 ...
 private:
  ...
  XWalkExternalExtension::PermissionsDelegate* permissions_delegate_;
};
