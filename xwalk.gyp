      ...
      'conditions': [
        ...
        ['OS=="android"',{
          'sources': [
            ...
            'runtime/browser/android/renderer_host/xwalk_resource_dispatcher_host_delegate.cc',
            'runtime/browser/android/renderer_host/xwalk_resource_dispatcher_host_delegate.h',
