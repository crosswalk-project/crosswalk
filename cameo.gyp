  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'src/runtime/browser/ui/app_modal_dialogs/app_modal_dialog.cc',
        'src/runtime/browser/ui/app_modal_dialogs/app_modal_dialog.h',
        'src/runtime/browser/ui/app_modal_dialogs/app_modal_dialog_queue.cc',
        'src/runtime/browser/ui/app_modal_dialogs/app_modal_dialog_queue.h',
        'src/runtime/browser/ui/app_modal_dialogs/javascript_app_modal_dialog.cc',
        'src/runtime/browser/ui/app_modal_dialogs/javascript_app_modal_dialog.h',
        'src/runtime/browser/ui/app_modal_dialogs/javascript_dialog_manager.cc',
        'src/runtime/browser/ui/app_modal_dialogs/javascript_dialog_manager.h',
        'src/runtime/browser/ui/app_modal_dialogs/native_app_modal_dialog.h',
        'src/runtime/browser/ui/views/javascript_app_modal_dialog_views.cc',
        'src/runtime/browser/ui/views/javascript_app_modal_dialog_views.h',
        'src/runtime/browser/ui/gtk/javascript_app_modal_dialog_gtk.cc',
        'src/runtime/browser/ui/gtk/javascript_app_modal_dialog_gtk.h',
        'src/runtime/browser/ui/gtk/gtk_util.cc',
        'src/runtime/browser/ui/gtk/gtk_util.h',
