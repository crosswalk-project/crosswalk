  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'src/runtime/browser/devtools/cameo_devtools_delegate.cc',
        'src/runtime/browser/devtools/cameo_devtools_delegate.h',
        'src/runtime/browser/devtools/remote_debugging_server.cc',
        ...
        'src/runtime/browser/runtime_file_select_helper.h',
        'src/runtime/browser/runtime_network_delegate.cc',
        'src/runtime/browser/runtime_network_delegate.h',
        'src/runtime/browser/runtime_platform_util.h',
        'src/runtime/browser/runtime_platform_util_common_linux.cc',
        'src/runtime/browser/runtime_platform_util_linux.cc',
        'src/runtime/browser/runtime_platform_util_win.cc',
        'src/runtime/browser/runtime_registry.cc',
        'src/runtime/browser/runtime_registry.h',
        'src/runtime/browser/runtime_select_file_policy.cc',
        'src/runtime/browser/runtime_select_file_policy.h',
        'src/runtime/browser/runtime_url_request_context_getter.cc',
        'src/runtime/browser/runtime_url_request_context_getter.h',
        'src/runtime/browser/ui/color_chooser.cc',
        'src/runtime/browser/ui/color_chooser.h',
        'src/runtime/browser/ui/color_chooser_dialog_win.cc',
        'src/runtime/browser/ui/color_chooser_dialog_win.h',
        'src/runtime/browser/ui/color_chooser_gtk.cc',
        'src/runtime/browser/ui/color_chooser_win.cc',
