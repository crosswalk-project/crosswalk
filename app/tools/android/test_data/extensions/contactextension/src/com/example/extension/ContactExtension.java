...
public class ContactExtension extends XWalkExtensionClient {
    ...
    public ContactExtension(String name, String JsApiContent, XWalkExtensionContextClient context) {
	...
	void writeContact(String name, String phone) {
		...
		Uri rawContactUri = cActivity.getContentResolver()
		...
		cActivity.getContentResolver().insert(
		...
		cActivity.getContentResolver().insert(
			android.provider.ContactsContract.Data.CONTENT_URI, values);
		//android.widget.Toast.makeText(cActivity, "Added person successfully.", Toast.LENGTH_LONG).show();
	}
}
