...
def CustomizeLaunchScreen(parser_from_makeapk, sanitized_name):
  app_root = os.path.dirname(parser_from_makeapk.input_path)
  default = CustomizeByOrientation(parser_from_makeapk, 'default',
                                   sanitized_name, app_root)
  portrait = CustomizeByOrientation(parser_from_makeapk, 'portrait',
                                    sanitized_name, app_root)
  landscape = CustomizeByOrientation(parser_from_makeapk, 'landscape',
                                     sanitized_name, app_root)
