...
def PrepareFromXwalk(src_dir, target_dir):
  ...
  source_target_list = [
    ...
    (os.path.join(xwalk_core_library_res_dir, 'menu'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/menu')),
    (os.path.join(xwalk_core_library_res_dir, 'drawable'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/drawable')),
    (os.path.join(xwalk_core_library_res_dir, 'drawable-hdpi'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/drawable-hdpi')),
    (os.path.join(xwalk_core_library_res_dir, 'drawable-mdpi'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/drawable-mdpi')),
    (os.path.join(xwalk_core_library_res_dir, 'drawable-xhdpi'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/drawable-xhdpi')),
    (os.path.join(xwalk_core_library_res_dir, 'layout'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/layout')),
    (os.path.join(xwalk_core_library_res_dir, 'layout-land'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/layout-land')),
    (os.path.join(xwalk_core_library_res_dir, 'layout-v17'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/layout-v17')),
    (os.path.join(xwalk_core_library_res_dir, 'mipmap-hdpi'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/mipmap-hdpi')),
    (os.path.join(xwalk_core_library_res_dir, 'mipmap-mdpi'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/mipmap-mdpi')),
    (os.path.join(xwalk_core_library_res_dir, 'mipmap-xhdpi'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/mipmap-xhdpi')),
    (os.path.join(xwalk_core_library_res_dir, 'mipmap-xxhdpi'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/mipmap-xxhdpi')),
    (os.path.join(xwalk_core_library_res_dir, 'values'),
     os.path.join(target_dir, 'libs_res/xwalk_core_library/values')),
