...
def merge_jars(jars, output_jar, root_out_dir):
  with build_utils.TempDir() as temp_dir:
    for jar_file in jars:
      build_utils.ExtractAll(root_out_dir+jar_file, path=temp_dir,
        pattern='*.class')
...
def main():
  ...
  library_part_jars = [
    ...
    '/lib.java/components/navigation_interception/android/'+
    'navigation_interception_java.jar',
    '/lib.java/components/web_contents_delegate_android/'
    ...
    '/lib.java/media/capture/video/android/capture_java.jar',
    '/lib.java/media/midi/midi_java.jar',
    '/lib.java/xwalk/extensions/android/xwalk_core_extensions_java.jar',
    '/lib.java/xwalk/runtime/android/core_internal/'+
    'xwalk_core_internal_java.jar',
  ...
  library_part_resources_jars = [
    '/gen/xwalk/runtime/android/core_internal_empty/'
    'xwalk_core_internal_empty_embedder_apk__java__compile_java.javac.jar',
  ]
