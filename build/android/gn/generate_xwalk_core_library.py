...
def CopyBinaries(out_dir, out_project_dir, src_package, shared):
  ...
  if shared:
    lib_to_copy = os.path.join(out_dir, 'lib.java',
      'xwalk_core_library_java_app_part.jar')
    target_file = os.path.join(libs_dir,
      'xwalk_core_library_java_app_part.jar')
  elif src_package:
    lib_to_copy = os.path.join(out_dir, 'lib.java', 'third_party',
      'jsr-305', 'jsr_305_javalib.jar')
...
def CopyResources(project_source, out_dir, out_project_dir, shared):
  ...
  res_to_copy = [
      ...
      ('content_java_resources',
       'gen/content/public/android/content_java_resources.resources.zip'),
      ('content_strings_grd',
       'gen/content/public/android/content_strings_grd.resources.zip'),
      ('ui_java_resources',
       'gen/ui/android/ui_java_resources.resources.zip'),
      ('ui_strings_grd',
      ...
      ('web_contents_delegate_android_java_resources',
       ...
       'web_contents_delegate_android_java_resources.resources.zip'),
      ('xwalk_core_internal_java_resources',
       'gen/xwalk/runtime/android/core_internal/'+
       'xwalk_core_internal_java_resources.resources.zip'),
      ('xwalk_core_java_resources',
       'gen/xwalk/runtime/android/core/'+
       'xwalk_core_java_resources.resources.zip'),
      ('xwalk_core_strings',
       'gen/xwalk/runtime/android/core_internal/'+
       'xwalk_core_strings.resources.zip'),
      ('xwalk_app_strings',
       'gen/xwalk/runtime/android/core/xwalk_app_strings.resources.zip')
  ]
  ...
  for (zip_name, zip_file) in res_to_copy:
    ...
    CopyDirAndPrefixDuplicates(subdir, res_dir, zip_name,
      blacklist=['OWNERS', 
                 'content_strings_grd__grit_stamp.d.stamp',
                 'ui_strings_grd__grit_stamp.d.stamp',
                 'xwalk_app_strings__grit_stamp.d.stamp',
                 'xwalk_core_strings__grit_stamp.d.stamp'])
