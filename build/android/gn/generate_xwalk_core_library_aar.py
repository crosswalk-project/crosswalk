...
def main():
  ...
  if options.shared:
    ...
    files = (
      ...
      (os.path.join(options.target, 'gen', 'xwalk', 'runtime', 'android', 
        'core_internal_empty',
        'xwalk_core_empty_embedder_apk__process_resources_R.txt'), 'R.txt'),
    )
    exclude_files = (
      os.path.join(options.target, 'xwalk_shared_library', 'libs',
    ...
    files = (
      (os.path.join(options.target, 'xwalk_core_library',
        'AndroidManifest.xml'),
       'AndroidManifest.xml'),
      (os.path.join(options.target, 'xwalk_core_library', 'libs',
      ...
      (os.path.join(options.target, 'gen', 'xwalk', 'runtime', 'android', 
        'core_internal_empty',
        'xwalk_core_empty_embedder_apk__process_resources_R.txt'),
       'R.txt'),
    )
