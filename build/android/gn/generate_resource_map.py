...
def GenerateRDotJava(gen_dir, resource_map_dir, stamp):
  ...
  srcjars= [
    ("gen/components/web_contents_delegate_android/web_contents_delegate_android_java_resources.srcjar",
    ...
    ("gen/xwalk/runtime/android/core_internal/xwalk_core_internal_java_resources.srcjar",
...
def main():
#  GenerateRDotTxt('gen', 'resource_map', 'resource.stamp'), R.txt is generated by empty apk.
