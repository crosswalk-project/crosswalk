...
def CopyJSBindingFiles(project_source, out_dir):
  ...
  jsfiles_to_copy = [
      ...
      'xwalk/runtime/android/core_internal/extension/api/contacts/contacts_api.js',
      'xwalk/runtime/android/core_internal/extension/api/device_capabilities/device_capabilities_api.js',
      'xwalk/runtime/android/core_internal/extension/api/messaging/messaging_api.js'
  ]
