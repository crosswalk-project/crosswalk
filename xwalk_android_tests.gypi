    ...
    },
    {
      ...
      'variables': {
        ...
        'additional_input_paths': [
          ...
          '<(PRODUCT_DIR)/runtime_client_shell/assets/manifest_empty_permission.json',
          '<(PRODUCT_DIR)/runtime_client_shell/assets/manifest_null_permission.json',
      ...
      'copies': [
        {
          ...
          'files': [
            ...
            'test/android/data/manifest_empty_permission.json',
            'test/android/data/manifest_null_permission.json',
    ...
    },
    {
      ...
      'variables': {
        ...
        'additional_input_paths': [
          ...
          '<(PRODUCT_DIR)/runtime_client_embedded_shell/assets/manifest_empty_permission.json',
          '<(PRODUCT_DIR)/runtime_client_embedded_shell/assets/manifest_null_permission.json',
