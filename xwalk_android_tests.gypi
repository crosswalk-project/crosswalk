    ...
    },
    {
      ...
      'variables': {
        ...
        'additional_input_paths': [
          ...
          '<(PRODUCT_DIR)/xwalk_xwview_test/assets/manifest.json',
          '<(PRODUCT_DIR)/xwalk_xwview_test/assets/manifest_with_local_url.json',
          '<(PRODUCT_DIR)/xwalk_xwview_test/assets/manifest_with_web_url.json',
      ...
      'copies': [
        {
          ...
          'files': [
            ...
            'test/android/data/manifest_with_local_url.json',
            'test/android/data/manifest_with_web_url.json',
