    ...
    },
    {
      ...
      'variables': {
        ...
        'additional_input_paths': [
          ...
          '<(PRODUCT_DIR)/sample/assets/file_chooser.html',
          '<(PRODUCT_DIR)/sample/assets/fullscreen.html',
          '<(PRODUCT_DIR)/sample/assets/js_modal_dialog.html',
          '<(PRODUCT_DIR)/sample/assets/manifest.json',
          '<(PRODUCT_DIR)/sample/assets/pause_timers.html',
          '<(PRODUCT_DIR)/sample/assets/request_focus_left_frame.html',
          '<(PRODUCT_DIR)/sample/assets/request_focus_main.html',
          '<(PRODUCT_DIR)/sample/assets/request_focus_right_frame.html',
          '<(PRODUCT_DIR)/sample/assets/request_focus_right_frame1.html',
          '<(PRODUCT_DIR)/sample/assets/scale_change.html',
      ...
      'copies': [
        {
          ...
          'files': [
            ...
            'runtime/android/sample/assets/file_chooser.html',
            'runtime/android/sample/assets/fullscreen.html',
            'runtime/android/sample/assets/js_modal_dialog.html',
            'runtime/android/sample/assets/manifest.json',
            'runtime/android/sample/assets/pause_timers.html',
            'runtime/android/sample/assets/request_focus_left_frame.html',
            'runtime/android/sample/assets/request_focus_main.html',
            'runtime/android/sample/assets/request_focus_right_frame.html',
            'runtime/android/sample/assets/request_focus_right_frame1.html',
            'runtime/android/sample/assets/scale_change.html',
            'test/android/data/echo.html',
            '<(PRODUCT_DIR)/xwalk.pak',
          ],
          'conditions': [
