...
void XWalkPresentationServiceDelegate::AddObserver(
...
void XWalkPresentationServiceDelegate::RemoveObserver(
    int render_process_id,
    int render_frame_id) {
  RenderFrameHostId id(render_process_id, render_frame_id);
...
void XWalkPresentationServiceDelegate::Reset(
    int render_process_id,
    int render_frame_id) {
  RenderFrameHostId id(render_process_id, render_frame_id);
  auto presentation_frame = presentation_frames_.get(id);
...
PresentationFrame* XWalkPresentationServiceDelegate::
