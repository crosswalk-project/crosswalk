...
#ifndef XWALK_RUNTIME_BROWSER_PRINTING_PRINT_JOB_WORKER_OWNER_H__
#define XWALK_RUNTIME_BROWSER_PRINTING_PRINT_JOB_WORKER_OWNER_H__
...
class PrintJobWorkerOwner
 ...
 public:
  ...
  virtual void GetSettingsDone(const printing::PrintSettings& new_settings,
                               printing::PrintingContext::Result result) = 0;
  ...
  virtual const printing::PrintSettings& settings() const = 0;
