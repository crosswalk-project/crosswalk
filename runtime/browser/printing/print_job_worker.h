...
#ifndef XWALK_RUNTIME_BROWSER_PRINTING_PRINT_JOB_WORKER_H_
#define XWALK_RUNTIME_BROWSER_PRINTING_PRINT_JOB_WORKER_H_
...
class PrintJobWorker {
 public:
  ...
  void StartPrinting(printing::PrintedDocument* new_document);

  // Updates the printed document.
  void OnDocumentChanged(printing::PrintedDocument* new_document);
 ...
 protected:
  ...
  printing::PrintingContext* printing_context() { return printing_context_.get(); }
 ...
 private:
  ...
  void SpoolPage(printing::PrintedPage* page);
  ...
  void GetSettingsDone(printing::PrintingContext::Result result);
  ...
  std::unique_ptr<printing::PrintingContext::Delegate>
      printing_context_delegate_;

  // Information about the printer setting.
  std::unique_ptr<printing::PrintingContext> printing_context_;
  ...
  printing::PageNumber page_number_;
