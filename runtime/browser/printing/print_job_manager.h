...
#ifndef XWALK_RUNTIME_BROWSER_PRINTING_PRINT_JOB_MANAGER_H_
#define XWALK_RUNTIME_BROWSER_PRINTING_PRINT_JOB_MANAGER_H_
...
#endif  // XWALK_RUNTIME_BROWSER_PRINTING_PRINT_JOB_MANAGER_H_
