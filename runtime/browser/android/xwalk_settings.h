...
#ifndef XWALK_RUNTIME_BROWSER_ANDROID_XWALK_VIEW_SETTINGS_H_
#define XWALK_RUNTIME_BROWSER_ANDROID_XWALK_VIEW_SETTINGS_H_
...
#endif  // XWALK_RUNTIME_BROWSER_ANDROID_XWALK_VIEW_SETTINGS_H_
