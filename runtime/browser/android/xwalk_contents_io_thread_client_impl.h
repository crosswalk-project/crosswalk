...
#ifndef ANDROID_XWALK_CONTENTS_IO_THREAD_CLIENT_IMPL_H_
#define ANDROID_XWALK_CONTENTS_IO_THREAD_CLIENT_IMPL_H_

#include "xwalk_contents_io_thread_client.h"
...
class XWalkContentsIoThreadClientImpl : public XWalkContentsIoThreadClient {
 public:
  ...
  // Java object.
  XWalkContentsIoThreadClientImpl(bool pending_associate,
                                  const base::android::JavaRef<jobject>& jclient);
...
#endif  // ANDROID_XWALK_CONTENTS_IO_THREAD_CLIENT_IMPL_H_
