...
#ifndef XWALK_RUNTIME_BROWSER_UI_DOWNLOAD_VIEWS_H_
#define XWALK_RUNTIME_BROWSER_UI_DOWNLOAD_VIEWS_H_
...
class DownloadBarView : public views::ButtonListener,
                        public views::View {
 public:
  explicit DownloadBarView(NativeAppWindow* app_view);
...
#endif  // XWALK_RUNTIME_BROWSER_UI_DOWNLOAD_VIEWS_H_
