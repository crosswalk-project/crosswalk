...
#ifndef XWALK_TEST_XWALKDRIVER_XWALK_ZIP_H_
#define XWALK_TEST_XWALKDRIVER_XWALK_ZIP_H_
...
// omit it.
typedef base::Callback<bool(const base::FilePath&)> FilterCallback;  // NOLINT
...
#endif  // XWALK_TEST_XWALKDRIVER_XWALK_ZIP_H_
