...
TEST(XwalkFinderTest, FindExeFound) {
  base::FilePath found =
...
TEST(XwalkFinderTest, FindExeShouldGoInOrder) {
...
TEST(XwalkFinderTest, FindExeShouldPreferExeNameOverDir) {
...
TEST(XwalkFinderTest, FindExeNotFound) {
  base::FilePath found =
      base::FilePath().AppendASCII("exists").AppendASCII("exists");
  std::vector<base::FilePath> existing_paths;
  std::vector<base::FilePath> rel_paths;
