...
#ifndef XWALK_TEST_XWALKDRIVER_XWALK_ZIP_READER_H_
#define XWALK_TEST_XWALKDRIVER_XWALK_ZIP_READER_H_
...
#else
#include "third_party/zlib/contrib/minizip/unzip.h"  // NOLINT(build/include_order)
#endif
...
#endif  // XWALK_TEST_XWALKDRIVER_XWALK_ZIP_READER_H_
