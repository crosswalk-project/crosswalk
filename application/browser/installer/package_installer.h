...
#ifndef XWALK_APPLICATION_BROWSER_INSTALLER_PACKAGE_INSTALLER_H_
#define XWALK_APPLICATION_BROWSER_INSTALLER_PACKAGE_INSTALLER_H_
...
#endif  // XWALK_APPLICATION_BROWSER_INSTALLER_PACKAGE_INSTALLER_H_
