...
#ifndef CAMEO_SRC_TEST_BASE_IN_PROCESS_BROWSER_TEST_H_
#define CAMEO_SRC_TEST_BASE_IN_PROCESS_BROWSER_TEST_H_
...
#endif  // CAMEO_SRC_TEST_BASE_IN_PROCESS_BROWSER_TEST_H_
