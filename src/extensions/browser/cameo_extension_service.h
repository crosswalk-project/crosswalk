...
#ifndef CAMEO_SRC_EXTENSIONS_BROWSER_CAMEO_EXTENSION_SERVICE_H_
#define CAMEO_SRC_EXTENSIONS_BROWSER_CAMEO_EXTENSION_SERVICE_H_
...
#endif  // CAMEO_SRC_EXTENSIONS_BROWSER_CAMEO_EXTENSION_SERVICE_H_
