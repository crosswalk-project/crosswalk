...
#ifndef CAMEO_SRC_EXTENSIONS_BROWSER_CAMEO_EXTENSION_WEB_CONTENTS_HANDLER_H_
#define CAMEO_SRC_EXTENSIONS_BROWSER_CAMEO_EXTENSION_WEB_CONTENTS_HANDLER_H_
...
#endif  // CAMEO_SRC_EXTENSIONS_BROWSER_CAMEO_EXTENSION_WEB_CONTENTS_HANDLER_H_
