...
#ifndef CAMEO_SRC_RUNTIME_BROWSER_RUNTIME_PLATFORM_UTIL_H_
#define CAMEO_SRC_RUNTIME_BROWSER_RUNTIME_PLATFORM_UTIL_H_
...
#endif  // CAMEO_SRC_RUNTIME_BROWSER_RUNTIME_PLATFORM_UTIL_H_
