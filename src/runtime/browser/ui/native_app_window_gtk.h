...
#ifndef CAMEO_SRC_RUNTIME_BROWSER_UI_NATIVE_APP_WINDOW_GTK_H_
#define CAMEO_SRC_RUNTIME_BROWSER_UI_NATIVE_APP_WINDOW_GTK_H_
...
#endif  // CAMEO_SRC_RUNTIME_BROWSER_UI_NATIVE_APP_WINDOW_GTK_H_
