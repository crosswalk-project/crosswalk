...
#ifndef CAMEO_SRC_RUNTIME_BROWSER_UI_COLOR_CHOOSER_DIALOG_WIN_H_
#define CAMEO_SRC_RUNTIME_BROWSER_UI_COLOR_CHOOSER_DIALOG_WIN_H_
...
#endif  // CAMEO_SRC_RUNTIME_BROWSER_UI_COLOR_CHOOSER_DIALOG_WIN_H_
