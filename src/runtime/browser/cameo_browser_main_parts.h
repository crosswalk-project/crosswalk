...
#ifndef CAMEO_SRC_RUNTIME_BROWSER_CAMEO_BROWSER_MAIN_PARTS_H_
#define CAMEO_SRC_RUNTIME_BROWSER_CAMEO_BROWSER_MAIN_PARTS_H_
...
#endif  // CAMEO_SRC_RUNTIME_BROWSER_CAMEO_BROWSER_MAIN_PARTS_H_
