...
#ifndef CAMEO_SRC_RUNTIME_BROWSER_RUNTIME_SELECT_FILE_POLICY_H_
#define CAMEO_SRC_RUNTIME_BROWSER_RUNTIME_SELECT_FILE_POLICY_H_
...
#endif  // CAMEO_SRC_RUNTIME_BROWSER_RUNTIME_SELECT_FILE_POLICY_H_
